...
export const GatheringsComponent = () => {
  const { container, list } = useStyles();

  return (
    <>
      <Container className={container} name="gatherings">
        <Box className={list}>
          <Box>
            <Typography variant="h5">Zbiórka “Lorem Ipsum 1”</Typography>
        ...
        <Box className={list}>
          <Box>
            <Typography variant="h5">Zbiórka “Lorem Ipsum 2”</Typography>
            <Typography variant="h6" style={{ margin: "20px 0" }}>
        ...
        <Box className={list}>
          <Box>
            <Typography variant="h5">Zbiórka “Lorem Ipsum 3”</Typography>
            <Typography variant="h6" style={{ margin: "20px 0" }}>
